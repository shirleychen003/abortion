...
@tbl-religion2006 displays the proportion of participants of each religion in the survey in 2006.

```{r}
#| label: tbl-religion2006
#| echo: false
#| warning: false
...
kable(religion2006_data, 
      col.names = c("Religion", "Count", "Percentage"),
      booktabs = TRUE,
      linesep = ""
      )
```

@tbl-religion2016 displays the proportion of participants of each religion in the survey in 2016.

```{r}
#| label: tbl-religion2016
#| echo: false
#| warning: false
#| tbl-cap: Respondent Religion Count and Percentage for 2016
